            ...
            foreach (Connector connector in connectorSet)
            {
                ...
                if (Domain.DomainHvac == connector.Domain || Domain.DomainPiping == connector.Domain)
                {
                    ...
                    sb.Append(
                        ...
                        + $"inst:FlowDirection_{connectorDirectionID} a fpo:NominalFlowDirection ;" + "\n"
                    ...
                    if (connector.Shape.ToString() == "Round")
                    {
                        ...
                        sb.Append(
                            ...
                            $"inst:Diameter_{connectorOuterDiameterID} a fpo:OuterDiameter ;" + "\n" +
                        ...
                        sb.Append(
                            ...
                            $"inst:CrossSectionArea_{crossSectionalAreaID} a fpo:CrossSectionalArea ;" + "\n" +
                    ...
                    else if (connector.Shape.ToString() == "Rectangular")
                    {
                        ...
                        sb.Append(
                            ...
                            $"inst:CrossSectionalArea_{crossSectionalAreaID} a fpo:CrossSectionalArea ;" + "\n" +
                            $"\tbrick:value '{crossSectionalArea}'^^xsd:double ;" + "\n" +
                            $"\tbrick:hasUnit unit:M ." + "\n"
                            );
                    }
                    ...
                    if (component.LookupParameter("ReynoldsNumber") != null)
                    {
                        ...
                        sb.Append(
                         ...
                         + $"inst:Re_{reynoldsID} a fpo:ReynoldsNumber ;" + "\n"
                    ...
                    if (component.LookupParameter("FrictionFactor") != null)
                    {
                        ...
                        sb.Append(
                         ...
                         + $"inst:FrictionFactor_{frictionFactorID} a fpo:FrictionFactor;" + "\n"
                    ...
                    if (component.LookupParameter("FlowState") != null)
                    {
                        ...
                        sb.Append(
                         ...
                         + $"inst:FlowState_{flowStateID} a fpo:FlowState ;" + "\n"
                    ...
                    if (connector.Flow != null)
                    {
                        ...
                        sb.Append($"inst:Port_{connectorID} ssn:hasProperty inst:VolumeFlow_{flowID} ." + "\n"
                         + $"inst:VolumeFlow_{flowID} a fpo:NominalVolumeFlow;" + "\n"
